...
const form = useForm({
  ...
  t_hominis: "",
  g_lambia_a_cyst: "",
  g_lambia_b_trophozoite: "",
  e_histolyca_a_cyst: "",
  e_histolyca_b_trophozoite: "",
  bacteria: "",
  others: "",
...
const submit = () => {
  form.post(route("stool-examinations.store"), {
    onSuccess: () => {
      const toast = useToast();
      toast.success("Stool examination record created successfully", {
        timeout: 3000,
      });
    },
  });
...
<template>
  <Head title="Create Stool Examination" />
        ...
        <div class="card">
          <div class="card-body p-4">
            ...
            <form class="row g-3" @submit.prevent="submit">
              ...
              <div class="row mb-3">
                <label for="e_histolyca_b_trophozoite" class="col-sm-3 col-form-label"
